  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-md-center" id="navbarNavAltMarkup">
    	...
    	<div class="navbar-nav center">
        	<a class="nav-link" href="/board/board_list.jsp">List</a>
      	...
      	%>
      		<a class="nav-link" href="/member/member_login.jsp">Login</a>
        	<a class="nav-link" href="/member/member_join.jsp">Join</a>
      	<%
      	} else {
      	%>
      		<a class="nav-link" href="#none">My Page</a>
      		<a class="nav-link" href="/member/member_login_action.jsp?IO=O">Logout</a>
      	<%
      	}
      	%>
      	</div>
